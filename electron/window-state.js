// Размер и место окна между запусками (1.1.0). Тот же модуль, что в калькуляторах
// (Calculators: calcpro-glass/window-state.js), в Paint Pro, SyncGlass и Translator AI.
//
...
// заголовка высотой 38 (полоса вкладок - 40) и хотя бы 80 по ширине.
